...
const topics =["Tailwind", "React"];
const question = ["jit-compilation", "purge-files", "dark-mode"];
const random = ["variants", "plugins"];
export const ChannelBar = ()=> {
    return(
        <>
        <section className="w-80 h-auto  ml-16 bg-gray-200 dark:bg-[#2B2D31] hidden md:block">
            <Header />
            <div className="flex flex-col items-center justify-start p-1 ">
            <Dropdown header={"Topics"} selections={topics}/>
            <Dropdown header={"Questions"} selections={question}/>
...
const TopicSelection = ({item}) =>(
    <>
    <div className="flex items-center justify-evenly mt-1 mr-auto ml-2 transition duration-200 ease-in-out cursor-pointer">
...
const Header = () =>(
    ...
    <div className="flex items-center justify-center h-16 m-0 p-0 ">
        <h5 className="text-lg text-gray-600 dark:text-gray-400 font-bold ml-4 mr-auto my-auto tracking-wider">Channels</h5>
    </div>
    </>
)